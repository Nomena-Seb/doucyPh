import logoLys from "../../../assets/logo/logoDoucyPro.png";
import catalogueProduit from "../../../assets/Ph/doucyPro.jpg";
import ProduitTemplate from "../ProduitTemplate";
import FondImage from "../../../assets/fond/doucyProFond.jpg";

export default function Produit6() {
  const paragraphs = [
